...
architecture behav of sandbox is 
    ...
    "sandbox,hls_ip_2014_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=6.666670,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=5.681000,HLS_SYN_LAT=2081283,HLS_SYN_TPT=2081284,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=489,HLS_SYN_LUT=754}";
    ...
    signal sandbox_AXIvideo2Mat_U0_ap_start : STD_LOGIC;
    signal sandbox_AXIvideo2Mat_U0_ap_done : STD_LOGIC;
    signal sandbox_AXIvideo2Mat_U0_ap_continue : STD_LOGIC;
    signal sandbox_AXIvideo2Mat_U0_ap_idle : STD_LOGIC;
    signal sandbox_AXIvideo2Mat_U0_ap_ready : STD_LOGIC;
    signal sandbox_AXIvideo2Mat_U0_AXI_video_strm_V_data_V_2 : STD_LOGIC_VECTOR (31 downto 0);
    signal sandbox_AXIvideo2Mat_U0_AXI_video_strm_V_data_V_2_ap_vld : STD_LOGIC;
    signal sandbox_AXIvideo2Mat_U0_video_in_TDATA : STD_LOGIC_VECTOR (23 downto 0);
    signal sandbox_AXIvideo2Mat_U0_video_in_TVALID : STD_LOGIC;
    signal sandbox_AXIvideo2Mat_U0_video_in_TREADY : STD_LOGIC;
    signal sandbox_AXIvideo2Mat_U0_video_in_TKEEP : STD_LOGIC_VECTOR (2 downto 0);
    signal sandbox_AXIvideo2Mat_U0_video_in_TSTRB : STD_LOGIC_VECTOR (2 downto 0);
    signal sandbox_AXIvideo2Mat_U0_video_in_TUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal sandbox_AXIvideo2Mat_U0_video_in_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal sandbox_AXIvideo2Mat_U0_video_in_TID : STD_LOGIC_VECTOR (0 downto 0);
    signal sandbox_AXIvideo2Mat_U0_video_in_TDEST : STD_LOGIC_VECTOR (0 downto 0);
    signal sandbox_AXIvideo2Mat_U0_img_data_stream_0_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal sandbox_AXIvideo2Mat_U0_img_data_stream_0_V_full_n : STD_LOGIC;
    signal sandbox_AXIvideo2Mat_U0_img_data_stream_0_V_write : STD_LOGIC;
    signal sandbox_AXIvideo2Mat_U0_img_data_stream_1_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal sandbox_AXIvideo2Mat_U0_img_data_stream_1_V_full_n : STD_LOGIC;
    signal sandbox_AXIvideo2Mat_U0_img_data_stream_1_V_write : STD_LOGIC;
    signal sandbox_AXIvideo2Mat_U0_img_data_stream_2_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal sandbox_AXIvideo2Mat_U0_img_data_stream_2_V_full_n : STD_LOGIC;
    signal sandbox_AXIvideo2Mat_U0_img_data_stream_2_V_write : STD_LOGIC;
    signal sandbox_AXIvideo2Mat_U0_img_data_stream_0_V_ap_vld : STD_LOGIC;
    signal sandbox_AXIvideo2Mat_U0_img_data_stream_1_V_ap_vld : STD_LOGIC;
    signal sandbox_AXIvideo2Mat_U0_img_data_stream_2_V_ap_vld : STD_LOGIC;
    signal ap_chn_write_sandbox_AXIvideo2Mat_U0_result_channel : STD_LOGIC;
    ...
    signal sandbox_Block_proc_U0_video_out_TDATA : STD_LOGIC_VECTOR (23 downto 0);
    signal sandbox_Block_proc_U0_video_out_TVALID : STD_LOGIC;
    signal sandbox_Block_proc_U0_video_out_TREADY : STD_LOGIC;
    signal sandbox_Block_proc_U0_video_out_TKEEP : STD_LOGIC_VECTOR (2 downto 0);
    signal sandbox_Block_proc_U0_video_out_TSTRB : STD_LOGIC_VECTOR (2 downto 0);
...
begin
    ...
    sandbox_AXIvideo2Mat_U0 : component sandbox_AXIvideo2Mat
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    ap_reg_procdone_sandbox_AXIvideo2Mat_U0_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if ((ap_const_logic_1 = ap_sig_hs_done)) then 
                    ap_reg_procdone_sandbox_AXIvideo2Mat_U0 <= ap_const_logic_0;
                elsif ((ap_const_logic_1 = sandbox_AXIvideo2Mat_U0_ap_done)) then 
    ...
    ap_chn_write_sandbox_AXIvideo2Mat_U0_result_channel <= sandbox_AXIvideo2Mat_U0_ap_done;
    ap_done <= ap_sig_hs_done;

    -- ap_idle assign process. --
    ap_idle_assign_proc : process(sandbox_AXIvideo2Mat_U0_ap_idle, sandbox_Block_proc_U0_ap_idle, result_channel_empty_n)
    begin
        if (((ap_const_logic_1 = sandbox_AXIvideo2Mat_U0_ap_idle) and (ap_const_logic_1 = sandbox_Block_proc_U0_ap_idle) and (result_channel_empty_n = ap_const_logic_0))) then 
    ...
    ap_sig_top_allready <= sandbox_AXIvideo2Mat_U0_ap_ready;
    result_channel_U_ap_dummy_ce <= ap_const_logic_1;
    result_channel_din <= sandbox_AXIvideo2Mat_U0_AXI_video_strm_V_data_V_2;
    result_channel_read <= sandbox_Block_proc_U0_ap_ready;
    result_channel_write <= ap_chn_write_sandbox_AXIvideo2Mat_U0_result_channel;
    sandbox_AXIvideo2Mat_U0_ap_continue <= result_channel_full_n;
    sandbox_AXIvideo2Mat_U0_ap_start <= ap_start;
    ...
    sandbox_AXIvideo2Mat_U0_video_in_TDATA <= video_in_TDATA;
    sandbox_AXIvideo2Mat_U0_video_in_TDEST <= video_in_TDEST;
    sandbox_AXIvideo2Mat_U0_video_in_TID <= video_in_TID;
    sandbox_AXIvideo2Mat_U0_video_in_TKEEP <= video_in_TKEEP;
    sandbox_AXIvideo2Mat_U0_video_in_TLAST <= video_in_TLAST;
    sandbox_AXIvideo2Mat_U0_video_in_TSTRB <= video_in_TSTRB;
    sandbox_AXIvideo2Mat_U0_video_in_TUSER <= video_in_TUSER;
    sandbox_AXIvideo2Mat_U0_video_in_TVALID <= video_in_TVALID;
