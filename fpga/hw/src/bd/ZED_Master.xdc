...
# JA Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property IOSTANDARD LVCMOS33 [get_ports {user_gpio_tri_io[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {user_gpio_tri_io[2]}]
...
set_property PACKAGE_PIN Y10 [get_ports {user_gpio_tri_io[0]}]
set_property PACKAGE_PIN AB9 [get_ports {user_gpio_tri_io[1]}]
set_property PACKAGE_PIN AA9 [get_ports {user_gpio_tri_io[2]}]
set_property PACKAGE_PIN AA8 [get_ports {user_gpio_tri_io[3]}]
