...
# JA Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property IOSTANDARD LVCMOS33 [get_ports {user_gpio_in_tri_i[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {user_gpio_in_tri_i[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {user_gpio_out_tri_o[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {user_gpio_out_tri_o[1]}]
#set_property PACKAGE_PIN Y11  [get_ports {JA1}];  # "JA1" I2C1-CLK
#set_property PACKAGE_PIN AA11 [get_ports {JA2}];  # "JA2" I2C1-DAT
set_property PACKAGE_PIN Y10 [get_ports {user_gpio_in_tri_i[0]}]
set_property PACKAGE_PIN AB9 [get_ports {user_gpio_in_tri_i[1]}]
set_property PACKAGE_PIN AA9 [get_ports {user_gpio_out_tri_o[0]}]
set_property PACKAGE_PIN AA8 [get_ports {user_gpio_out_tri_o[1]}]
#set_property PACKAGE_PIN AB11 [get_ports {JA7}];  # "JA7", I2C2-CLK
#set_property PACKAGE_PIN AB10 [get_ports {JA8}];  # "JA8", I2C2-DAT
#
#
## ----------------------------------------------------------------------------
## JB Pmod - Bank 13
...
# Vivado 2015.4 made these read-only. Encryption arguments must be passed to BootGen
