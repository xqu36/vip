...
set C_modelArgMapList {[ 
	{ "Name" : "result", "interface" : "wire", "bitwidth" : 32} , 
 	{ "Name" : "video_out_V_data_V", "interface" : "axis", "bitwidth" : 16} , 
 	{ "Name" : "video_out_V_keep_V", "interface" : "axis", "bitwidth" : 2} , 
 	{ "Name" : "video_out_V_strb_V", "interface" : "axis", "bitwidth" : 2} , 
...
set portList { 
	...
	{ video_out_TDATA sc_out sc_lv 16 signal 1 } 
	{ video_out_TVALID sc_out sc_logic 1 outvld 7 } 
	{ video_out_TREADY sc_in sc_logic 1 outacc 7 } 
	{ video_out_TKEEP sc_out sc_lv 2 signal 2 } 
	{ video_out_TSTRB sc_out sc_lv 2 signal 3 } 
