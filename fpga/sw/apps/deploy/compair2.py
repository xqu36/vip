import os
os.system('dpkg --get-selections | grep -v deinstall > /home/ubuntu/deploy/allpacks.txt') 
os.system('sudo rm /home/ubuntu/deploy/deletepacks.sh')
f=open('/home/ubuntu/deploy/allpacks.txt','r')
i=0
atall = 0
for line in f:
    k=open('/home/ubuntu/deploy/hispacks.txt','r')
    end = 0
    j = 0
    match = 0
    while end == 0:
    ...
    for line in k.readlines():
        ...
        if inser == check:
            ...
            pass
    if match == 0:
    	d=open('/home/ubuntu/deploy/deletepacks.sh','a')
...
if i != 0:
    ...
    if response == "d":
        os.system('sudo chmod a+x /home/ubuntu/deploy/deletepacks.sh')
        os.system('./home/ubuntu/deploy/deletepacks.sh')
        ...
        os.system('sudo rm /home/ubuntu/deploy/hispacks.txt')
